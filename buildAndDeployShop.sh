...
SRC_WEB_APP_CONFIG_DEPLOYMENT_PATH="${SRC_WEB_APP_ROOT_LOC}/deployment/config"
...
APP_SERVER_WEB_CONFIG_PATH="$APP_SERVER_HOME/config"
APP_SERVER_WEB_LOG_PATH="${APP_SERVER_HOME}/logs"
