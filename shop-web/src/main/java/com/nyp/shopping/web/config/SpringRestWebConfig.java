...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.nyp.shopping.web.controller.rest", "com.nyp.shopping.web.controller.advice" })
public class SpringRestWebConfig extends WebMvcConfigurerAdapter {
